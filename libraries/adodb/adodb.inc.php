...
*/
	...
	class ADODB_Cache_File {
		...
		public function createdir($hash, $debug) {
			...
			if ($this->notSafeMode && !file_exists($dir)) {
				$oldu = umask(0);
				if (!mkdir($dir, empty($ADODB_CACHE_PERMS) ? 0771 : $ADODB_CACHE_PERMS) && !is_dir($dir)) {
					if(!is_dir($dir) && $debug) {
	...
	*/
	...
	public function NConnect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "") {
         ...
         * @param string $argPassword
         * @param string $argDatabaseName
         * @return bool|int|true true or false
         */
	...
	*/
	...
	public function SetFetchMode($mode) {
         ...
         * @param $sql
         * @param bool $inputarr
         * @return ADORecordSet|bool|false
         */
	public function Query($sql, $inputarr=false) {
         ...
         * @param $count
         * @param bool $params
         * @return ADORecordSet|bool|false|RecordSet
         */
	...
	*/
	...
	public function DropSequence($seqname='adodbseq') {
         ...
         * @param int $startID
         * @return int|mixed 0 if not supported, otherwise a sequence id
         */
	...
	*/
	...
	public function ErrorMsg() {
        ...
        /**
         * @return int last error number. Normally 0 means no error.
         */
	...
	public function SelectDB($dbName) {return false;
         ...
         * @return ADORecordSet|bool|false|RecordSet recordset ($rs->databaseType == 'array')
         */
...
*/
	...
	public function RollbackTrans() {
         ...
         *
         * @return array|bool array of database names.
         */
	public function MetaDatabases() {
         ...
         * @param null $procedureNamePattern
         * @param null $catalog
         * @param null $schemaPattern
         * @return bool of procedures on current database.
         *
         * Array(
	...
	public function MetaColumns($table, $normalize=true) {
         ...
         * @param bool $primary
         * @param bool $owner
         * @return bool of indexes on current table. Each element represents an index, and is itself an associative array.
         *
         * Array(
         *   [name_of_index] => Array(
	...
	public function DBTimeStamp($ts, $isfld=false) {
         ...
         *
         * @return bool|false|float|int|is in unix timestamp format, or 0 if before TIMESTAMP_FIRST_YEAR, or false if invalid date format
         */
	public static function UnixDate($v) {
         ...
         *
         * @return bool|false|float|int in unix timestamp format, or 0 if before TIMESTAMP_FIRST_YEAR, or false if invalid date format
         */
	...
	* @return	The SQL text
	*/
	public function substr($fld, $start, $length=0) {
	...
	*/
                             ...
                             $size=0, $selectAttr='')
	{
         ...
         *
         * @param int $nRows
         * @return array array indexed by the rows (0-based) from the recordset
         */
	...
	*/
	public function FetchRow() {
         ...
         *
         * @param $arr
         * @return bool|int|PEAR_Error or error object
         */
	...
	*/
	...
	public function PO_RecordCount($table="", $condition="") {
        ...
        /**
         * @return int current row in the recordset. If at EOF, will return the last row. 0-based.
         */
	...
	public function AbsolutePosition() {
        ...
        /**
         * @return int number of columns in the recordset. Some databases will set this to 0
	...
	public function FieldTypesArray() {
         ...
         *
         * @return ADOFetchObj object with the properties set to the fields of the current row
         */
	...
	*/
	public function FetchNextObj() {
         ...
         * @param bool $isupper to set the object property names to uppercase
         *
         * @return ADOFetchObj|bool object with the properties set to the fields of the current row,
         *    or false if EOF
         *
         * Fixed bug reported by tim@orotech.net
         */
